...
<h1><xsl:call-template name="modellabel"> </xsl:call-template> 
</h1>
...
<!--Show Classes  -->	
		...
		<xsl:for-each select="rdfs:Class|owl:Class">
			<div class="resource">
			<h3><xsl:call-template name="resourcelabel"> </xsl:call-template> </h3>
			<dl><xsl:call-template name="info"> </xsl:call-template></dl>  
			</div>		
	   </xsl:for-each>
	   </xsl:if>
...
<!--Show SKOS CONCEPT INSTANCES  -->
		...
		<xsl:if test="rdf:type[@rdf:resource='http://www.w3.org/2004/02/skos/core#Concept']"> 
			<div class="resource"><h3><xsl:call-template name="resourcelabel"> </xsl:call-template> </h3>
			<dl><xsl:call-template name="info"> </xsl:call-template> 
...
<xsl:template name="info">
					  ...
					  <xsl:call-template name="applicationnotes"> </xsl:call-template>  
					  <xsl:apply-templates select="applicationNote"/>	
</xsl:template>
...
<xsl:template match="applicationNote">
			<!--Show usage note  -->
					<div class="usage">
